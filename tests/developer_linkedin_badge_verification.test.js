...
assert(swJs.includes('oc-pwa-cache-v2.11.69'), 'Service worker cache name should be updated to v2.11.69');
assert(indexHtml.includes('v=2.11.69'), 'index.html should have cache buster v=2.11.69');
assert(!indexHtml.includes('v=2.11.68'), 'index.html should not have old cache buster v=2.11.68');
console.log('✓ Cache buster version v2.11.69 verified');
