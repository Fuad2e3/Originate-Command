...
assert(swJs.includes('oc-pwa-cache-v2.11.71'), 'Service worker cache name should be updated to v2.11.71');
assert(indexHtml.includes('v=2.11.71'), 'index.html should have cache buster v=2.11.71');
assert(!indexHtml.includes('v=2.11.70'), 'index.html should not have old cache buster v=2.11.70');
console.log('✓ Cache buster version v2.11.71 verified');
