...
assert(swJs.includes('oc-pwa-cache-v2.11.83'), 'Service worker cache name should be updated to v2.11.83');
assert(indexHtml.includes('v=2.11.83'), 'index.html should have cache buster v=2.11.83');
assert(!indexHtml.includes('v=2.11.80'), 'index.html should not have old cache buster v=2.11.80');
console.log('✓ Cache buster version v2.11.83 verified');
