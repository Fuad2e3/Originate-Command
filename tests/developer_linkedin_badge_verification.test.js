...
assert(swJs.includes('oc-pwa-cache-v2.11.67'), 'Service worker cache name should be updated to v2.11.67');
assert(indexHtml.includes('v=2.11.67'), 'index.html should have cache buster v=2.11.67');
assert(!indexHtml.includes('v=2.11.66'), 'index.html should not have old cache buster v=2.11.66');
console.log('✓ Cache buster version v2.11.67 verified');
