...
assert(swJs.includes('oc-pwa-cache-v2.11.66'), 'Service worker cache name should be updated to v2.11.66');
assert(indexHtml.includes('v=2.11.66'), 'index.html should have cache buster v=2.11.66');
assert(!indexHtml.includes('v=2.11.65'), 'index.html should not have old cache buster v=2.11.65');
console.log('✓ Cache buster version v2.11.66 verified');
