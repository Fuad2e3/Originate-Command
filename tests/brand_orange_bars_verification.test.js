...
assert(indexHtml.includes('v=2.11.77'), 'index.html must reference v=2.11.77');
assert(swJs.includes('oc-pwa-cache-v2.11.77'), 'sw.js must reference v2.11.77');
console.log('✓ Cache buster version v2.11.77 verified across assets');
