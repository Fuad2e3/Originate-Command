...
assert(indexHtml.includes('v=2.11.78'), 'index.html must reference v=2.11.78');
assert(swJs.includes('oc-pwa-cache-v2.11.78'), 'sw.js must reference v2.11.78');
console.log('✓ Cache buster version v2.11.78 verified across assets');
