...
assert(indexHtml.includes('v=2.11.82'), 'index.html must reference v=2.11.82');
assert(swJs.includes('oc-pwa-cache-v2.11.82'), 'sw.js must reference v2.11.82');
console.log('✓ Cache buster version v2.11.82 verified across assets');
