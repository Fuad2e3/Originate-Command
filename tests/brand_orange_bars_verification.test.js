...
assert(indexHtml.includes('v=2.11.83'), 'index.html must reference v=2.11.83');
assert(swJs.includes('oc-pwa-cache-v2.11.83'), 'sw.js must reference v2.11.83');
console.log('✓ Cache buster version v2.11.83 verified across assets');
