# Originate Command Rules (from dev3/Rules.md and dev3/GEMINI.md)

Always strictly follow and uphold all core rules and specifications defined in `dev3/Rules.md` and `dev3/GEMINI.md`:
